...
const ValuesSection: FC<ValuesSectionProps> = memo(({}) => {
  return (
    <div id="services" className="h-screen bg-white">
      <section className="min-h-16 p-5 lg:p-0 grid h-[530px] lg:grid-cols-2 bg-slate-100/50  ">
        <div>
          <img
        ...
        <div className="grid grid-cols-2 gap-y-10 lg:gap-x-1 items-center">
          <div className="col-span-2  max-w-xl ">
            ...
            <p className="mt-2 whitespace-break-spaces text-lg text-purple-950/50">
              We always want to provide the best value for you <br/>and your health,
          ...
          <div className="col-span-1 w-52 md:w-64 lg:w-72 rounded-3xl bg-purple-200/25 ring ring-white shadow-md p-5  hover:shadow-lg">
            <div className="-mb-5 ml-2 w-fit -translate-y-10 rounded-xl bg-purple-600 p-2 text-white ring-2 ring-gray-400 ">
              <GiHeartPlus size={30} />
            </div>
            <div>
